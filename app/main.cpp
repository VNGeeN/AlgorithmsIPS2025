...
// Кросс-платформенная обёртка для работы с файловой системой
...
private:
    ...
    void createSampleTestFiles() {
        // Sample test file 1: Basic operations
        ...
        // Sample test file 4: Complex expressions
...
int main(int argc, char* argv[]) {
    ...
    // If filename provided as command line argument, process it directly
    if (argc == 2) {
